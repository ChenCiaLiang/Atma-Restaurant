      ...
      <div class="d-flex justify-content-end">
        <div class="container" style="margin-top:15vh;margin-left:1vw;">
          ...
          <div class="container" style="margin-top:4vh;display:flex;align-items:center;">
              ...
              <a type="button" href="{{url('sign-up')}}" class="btn btn-outline-light" style="border-color:black;height:2vh;width:8vw;display:flex;justify-content:center;align-items:center;margin-left:1vw;font-size:1vw;padding:1rem;border-radius:25px">
                  Register
              </a>
          </div>
        </div>
