...
<!-- Navbar -->
  ...
  <div class="hero-section" style="background-image: url('image/homepage.png');">
    <div class="content" style="background-color: rgba(0, 0, 0, 0.5);
      ...
      <p style="font-size:1vw">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ultricies erat at nisi ultrices vehicula. Donec blandit risus orci, varius vestibulum felis sagittis ac. Vestibulum nec vulputate odio, eget rhoncus ex. </p>
      <button type="button" class="btn btn-light" style="border-radius:3vw;font-size:2vw;padding-left:3vw;padding-right:3vw;margin-top:2vh"><strong>View Menu</strong></button>
    </div>
  </div>
  ...
  <div class="container-fluid" style="background-color: rgba(247, 132, 5, 0.5);width:100%;height:100%;padding-top:15rem;padding-bottom:15rem;">
    ...
    <div class="row g-3"style="justify-content:center;align-items:center;padding-top:5rem;">
      <div class="col-12 col-sm-6 col-md-2"  style="margin: 0 1rem;">
        <div class="card" style="width: 18rem;border-radius:15px; padding: 1rem;">
          <div style="display: flex; align-items: center;">
            <img class="rounded-circle" src="{{asset('image/hansohee.png')}}" alt="Card image cap" style="width:80px;height:80px;object-fit:cover;">
            <h5 class="card-title" style="margin-left: 15px;">Han Sohee</h5>
          </div>
          <div class="card-body" style="text-align:center;">
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ultricies erat at nisi ultrices vehicula. Donec blandit risus orci, varius vestibulum felis sagittis ac. Vestibulum nec vulputate odio, eget rhoncus ex. </p>
          </div>
        </div>
      ...
      <div class="col-12 col-sm-6 col-md-2"  style="margin: 0 1rem;">
        <div class="card" style="width: 18rem;border-radius:15px; padding: 1rem;">
          <div style="display: flex; align-items: center;">
            <img class="rounded-circle" src="{{asset('image/parkjimin.png')}}" alt="Card image cap" style="width:80px;height:80px;object-fit:cover;">
      ...
      <div class="col-12 col-sm-6 col-md-2"  style="margin: 0 1rem;">
       <div class="card" style="width: 18rem;border-radius:15px; padding: 1rem;">
          <div style="display: flex; align-items: center;">
            <img class="rounded-circle" src="{{asset('image/shin.png')}}" alt="Card image cap" style="width:80px;height:80px;object-fit:cover;">
