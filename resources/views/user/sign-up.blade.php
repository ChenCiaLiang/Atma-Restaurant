      ...
      <div class="d-flex justify-content-end">
        <div class="container" style="margin-top:15vh;margin-left:1vw;">
          ...
          <form action="{{url('login')}}">
            ...
            <div class="form-floating mb-2" >
              <input type="text" class="form-control" id="floatingInput" placeholder="Email" style="border-radius:50px;width:30vw;padding-left:2vw;" required >
            ...
            <div class="form-floating mb-2" >
              <input type="date" class="form-control" id="floatingInput" style="border-radius:50px;width:30vw;padding-left:2vw; padding-top:0;padding-right:1vw;padding-bottom:0;" required >
            </div>
            ...
            <div style="display:flex;justify-content:center;align-items:center;">
              <button class="btn btn-success" type="submit" style="width:10vw;border-radius:25px;background-color:rgba(54, 61, 32, 1);margin-top:1vh;background-color:rgba(247, 132, 5, 1);border:none;">
          ...
          <div class="container" style="margin-top:3vh;display:flex;align-items:center;margin-left:1.5vw;">
              ...
              <a type="button" href="{{url('login')}}" class="btn btn-outline-light" style="border-color:black;height:2vh;width:8vw;display:flex;justify-content:center;align-items:center;margin-left:1vw;font-size:1vw;padding:1rem;border-radius:25px;background-color:rgba(247, 132, 5, 1);border:none;">
                  Login
              </a>
          </div>
        </div>
