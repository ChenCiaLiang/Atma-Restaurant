  ...
  <div class="grid-container justify-content-center align-content-center" >
      <div class="item1">
        <div class="card align-items-center" style="padding:5vh;border-radius:25px">
          <h1 class="card-title">My Profile <a class="bi bi-pencil-square" href="{{url('edit')}}" style="color:black;"></a></h1>
      ...
      <div class="item2">
        <div class="card text-start" style="padding:2rem;border-radius:25px;" >
          ...
          <div class="card-body " style="padding-left:20vw;padding-right:20vw;">
            <p class="card-text text-center" style="font-size:3vw;color:grey;"><i class="fa-solid fa-utensils"></i></p>
            <p class="card-text text-center" style="color:grey;">History not found .. <br>order food <a href="#" style="color:grey;">here</a></p>
          </div>
        </div>
      </div>
      ...
      <div class="item4 text-start">
        <a type="button" class="btn btn-light" style="font-size:2rem;padding:15px;border-radius:30px;" href="{{url('login')}}">Logout <i class="bi bi-box-arrow-right"></i></a>
      </div>
  </div>
