    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link bi bi-cart-fill" style="color: white;display: inline-block; border-bottom: 1px solid white;" href="#" ></a>
          </li>
      ...
      <div style="padding:5px;">
          ...
          <div class="container">
            <div class="card mb-3" style="width:30vw;height:15vh;">
              <div class="row g-0">
                <div class="col">
                  <img src="{{asset('image/bibimbap.png')}}" class="img-fluid rounded-start" style="width:100%;height:86%;object-fit:cover;" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
            ...
            <div class="card mb-3" style="width:30vw;height:15vh;">
              <div class="row g-0">
                <div class="col">
                  <img src="{{asset('image/ramen.png')}}" class="img-fluid rounded-start" style="width:100%;height:86%;object-fit:cover;" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
            ...
            <div class="card mb-3" style="width:30vw;height:15vh;">
              <div class="row g-0">
                <div class="col">
                  <img src="{{asset('image/thai.png')}}" class="img-fluid rounded-start"  style="width:100%;height:83%;object-fit:cover;" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title text-start" style="font-size:1vw;">Bibimbap</h5>
              ...
              <div class="card" style="width: 30vw;">
                <div class="card-body">
                  ...
                  <div class="row">  
                      ...
                      <p class="col card-text text-end" style="font-size:1vw;"><strong>Rp201.300</strong></p>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container mt-5">
    <div class="row">  
        ...
        <div class="col" style="margin-left:42%;">
         <button style="width:8vw;height:5vh;border-radius:25px;margin-right:3%;background-color:#F78405;color:white;font-size:0.8vw;">QRIS</button>
         <button style="width:8vw;height:5vh;border-radius:25px;background-color:#F78405;color:white;font-size:0.8vw;">Virtual Account</button>
        </div>
    </div>
  </div>
