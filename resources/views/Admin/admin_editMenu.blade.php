                ...
                <div class="col-8">
                    <div class="card container-fluid" style="background-color: #F2D55F">
                        <div class="row">
                            ...
                            <div class="col mt-4">
                                <h5>Nama Menu:</h5>
                                <h4 class="fw-bold">Japchae</h4>
                                <h5>Kategori:</h5>
                                <h4 class="fw-bold">Noodles</h4>
                                <h5>Harga:</h5>
                                <h4 class="fw-bold">Rp 85.000</h4>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="container-fluid d-flex flex-column justify-content-center editMenu mb-4" style="background-color: #E2D8AD; max-width: 90%; border-radius: 20px;">
                                <form class="container-fluid p-0" action="{{ url('admin_editMenu') }}">
                                    <div class="mx-3">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="harga" placeholder="Harga" required>
