...
<body>
    <div class="d-flex justify-content-start" style="background-color:rgba(171, 171, 128, 1)">
        ...
        <div class="container" style="margin-top:15vh;margin-left:1vw;">
          ...
          <form action="{{url('login')}}">
            ...
            <div style="display:flex;justify-content:center;align-items:center;">
              <button class="btn btn-success" type="submit" style="width:10vw;border-radius:25px;background-color:rgba(54, 61, 32, 1);margin-top:1vh;">
          ...
          <div class="container" style="margin-top:3vh;display:flex;align-items:center;margin-left:1.5vw;">
              ...
              <a type="button" href="{{url('login')}}" class="btn btn-outline-light" style="border-color:black;height:2vh;width:8vw;display:flex;justify-content:center;align-items:center;margin-left:1vw;font-size:1vw;padding:1rem;border-radius:25px">
                  Login
              </a>
          </div>
        </div>
