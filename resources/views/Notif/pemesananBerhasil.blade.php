...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgba(247, 132, 5, 1);">
    ...
    <div style="text-align:center;margin-top:3%;">
      <h2 style="display:inline-block; border-bottom: 2px dashed black;text-align;font-size:5vw;font-family:Italianno;">Reservations</h2>
    </div>

    <div class="container text-center justify-content-center" style="background-color:black;border-radius:100%;width:10vw;height:20vh;background-color:white;margin-top:3%;">
    ...
    <div class="container text-center" style="margin-top:2%;">
      <p style="font-size:1vw;color:white;"><strong>YOUR TABLE IS BOOKED!</strong></p>
      <a href="{{url('menu')}}">
          <button class="btn btn-outline-light" type="submit"
              style="width:17vw;border-radius:5px;margin-top:5%;">
